...
#    feature_folder= "/home/ubuntu/bitstream_mode3_p1204_3/features/p1204_etri_features"
    ...
    speed_feature_folder = '../speed/speed_features_PR_mean'
    train_names = []
    val_names = [] 
...
#        else:
        ...
        try:
            ...
            feat_speed = load(os.path.join(speed_feature_folder,featfile_name))
            score = scores[i]
        except:
            print(featfile_name, ' was not found')
            continue
            
        feature = np.concatenate((feat_file['features'],[feat_speed['speed']]),dtype=np.float32)
