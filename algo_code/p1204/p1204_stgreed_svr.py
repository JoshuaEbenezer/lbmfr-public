...
#    feature_folder= "/home/ubuntu/bitstream_mode3_p1204_3/features/p1204_etri_features"
    ...
    stgreed_feature_folder = '../stgreed/lbvfr_features'
    train_names = []
    val_names = [] 
...
#        else:
        ...
        try:
            ...
            feat_stgreed = load(os.path.join(stgreed_feature_folder,featfile_name))
            score = scores[i]
        except:
            print(featfile_name, ' was not found')
            continue
            
        feature = np.concatenate((feat_file['features'],feat_stgreed['feature:']),dtype=np.float32)
